...
# Cache global para el esquema JSON
...
class Pipeline:
    ...
    def _load_schema(self) -> Optional[dict]:
        """Carga el esquema JSON desde caché o disco."""
    ...
    async def _save_output(
        ...
        # Track usage
        if "usage" in result:
            # No guardamos el estado aquí porque lo haremos justo después de actualizar results_cache

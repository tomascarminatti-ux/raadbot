...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Precompilar el validador de JSON schema para mejorar la velocidad de validación en ~14x
        if self.schema:
    ...
    def _validate_output(self, json_data: dict, gem_name: str) -> bool:
        ...
        try:
            # Usar el validador precompilado para evitar recompilar en cada llamada

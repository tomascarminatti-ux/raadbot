...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Performance optimization: pre-compile the jsonschema validator instance once
        # to avoid repeated schema parsing and validator compilation overhead (~14x speedup)
        self.validator = None
        if self.schema:

...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Precompile the schema validator once during initialization for high performance (~13.6x speedup)
        if self.schema:
    ...
    def _validate_output(self, json_data: dict, gem_name: str) -> bool:
        ...
        try:
            # Reusing precompiled validator to avoid dynamic compilation costs on every validation run

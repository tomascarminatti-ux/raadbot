...
def _get_cached_schema(schema_path: str) -> Optional[dict]:
    """Carga y almacena en caché el esquema JSON para evitar lecturas repetidas de disco."""
...
class Pipeline:
    ...
    def _load_schema(self) -> Optional[dict]:
        ...
        return _get_cached_schema(schema_path)

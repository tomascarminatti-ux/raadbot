...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Pre-compile the JSON schema validator to avoid recompiling the schema
        # on every GEM output validation call (~14x validation speedup).
        if self.schema:
    ...
    def _validate_output(self, json_data: dict, gem_name: str) -> bool:
        ...
        try:
            # Use pre-compiled validator instance for optimal performance

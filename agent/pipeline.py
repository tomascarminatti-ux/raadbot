...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Pre-compile JSON Schema validator to avoid recreating validator instance on every validation call (~15x speedup)
        self.validator = validator_for(self.schema)(self.schema) if self.schema else None
    ...
    def _validate_output(self, json_data: dict, gem_name: str) -> bool:
        ...
        try:
            # Use pre-compiled validator instance for ~15x faster schema validation

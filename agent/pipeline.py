...
# Cache global para el schema para evitar I/O redundante
_SCHEMA_CACHE = None
...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Pre-compilar el validador para mejorar performance (~14x speedup)
        self.validator = None
        if self.schema:
            val_cls = validator_for(self.schema)
            self.validator = val_cls(self.schema)

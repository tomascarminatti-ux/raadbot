...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Bolt performance optimization: Pre-compile jsonschema validator instance during initialization
        # to avoid costly schema re-compilation on every output validation call (~57x speedup).
        self.validator = (

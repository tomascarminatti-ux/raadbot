...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Bolt performance optimization: pre-compile jsonschema validator instance once
        # to avoid repeating schema parsing/meta-validation overhead on every GEM response validation.
        self.validator = (
            validators.validator_for(self.schema)(self.schema)
            if self.schema
            else None
        )

...
class Pipeline:
    ...
    def __init__(self, gemini: GeminiClient, search_id: str, output_dir: str):
        ...
        # Pre-compilar validador para mayor performance
        self.validator = validators.validator_for(self.schema)(self.schema) if self.schema else None
    ...
    async def _run_gem_with_validation(self, gem_name: str, prompt_vars: dict) -> dict:
        # El prompt no cambia entre reintentos, lo calculamos una vez

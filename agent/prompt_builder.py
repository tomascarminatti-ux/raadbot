...
def get_base_prompt(gem_name: str) -> str:
    """
    Obtiene el prompt base con el maestro ya inyectado (Cacheado).
    """
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    1. Obtiene el prompt base (GEM + Maestro) desde caché
    2. Reemplaza todas las {{variables}}

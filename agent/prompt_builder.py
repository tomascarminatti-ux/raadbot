...
# Pre-compile the variable search regex at the module level for faster matches
...
def clear_prompt_caches():
    """Limpia el cache de prompts para permitir recargar los templates modificados."""

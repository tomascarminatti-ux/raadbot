...
def _get_template_with_maestro(gem_name: str) -> str:
    """Carga el template del GEM e inyecta el maestro una sola vez."""
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    1. Carga el prompt del GEM (con maestro inyectado y cacheado)
    ...
    # Optimizamos inyectando variables en un solo paso usando re.sub con callback

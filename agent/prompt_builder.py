...
def _load_prompt_cached(filepath: str, mtime: float) -> str:
    """Carga un prompt desde disco utilizando cache LRU e invalidación por mtime."""
    with open(filepath, "r", encoding="utf-8") as f:
        return f.read()


def clear_prompt_caches():
    """Limpia la caché LRU de prompts."""
    _load_prompt_cached.cache_clear()


def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts utilizando caché."""

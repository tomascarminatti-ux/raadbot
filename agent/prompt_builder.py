...
def _load_prompt_cached(filepath: str, mtime: float) -> str:
    """Carga y almacena en caché el contenido del prompt basado en su mtime de modificación."""
    with open(filepath, "r", encoding="utf-8") as f:
        return f.read()


def clear_prompt_caches():
    """Limpia la caché de prompts en memoria."""
    _load_prompt_cached.cache_clear()


def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts con caché basado en mtime."""

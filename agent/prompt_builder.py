...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    # Preparar el mapa de sustitución incluyendo el maestro
    # Usamos un dict local para no modificar el original
    subs = {**variables, "PROMPT_MAESTRO": maestro}

    # Definir el callback para re.sub
    def replace_match(match):
        ...
        if key in subs:
            ...
            return str(val)
        return match.group(0)  # Mantener {{key}} si no está en subs

    # Reemplazar variables en un solo paso

...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    # Inyectar variables usando regex para reemplazo eficiente en un solo paso
    ...
    if remaining:
        ...
        unresolved = [v for v in remaining if v != "VERSION"]
        if unresolved:
            print(f"  ⚠️  Variables sin reemplazar en {gem_name}: {list(set(unresolved))}")

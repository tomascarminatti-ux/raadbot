...
def load_maestro() -> str:
    """Carga el prompt maestro. No se cachea directamente para permitir updates en cascada."""
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    """
    # Cargar prompt maestro y del GEM (cacheado en load_prompt)
    ...
    # Inyectar variables (Single-pass replacement for efficiency)

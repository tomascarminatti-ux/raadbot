...
# Pre-compile regex for faster variable detection
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    # Inyectar variables en una sola pasada usando re.sub para mayor eficiencia
    # Pre-procesar variables para manejar diccionarios
    processed_vars = {}

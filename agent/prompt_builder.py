...
def _load_prompt_cached(filepath: str, mtime: float) -> str:
    """Carga y almacena en caché el contenido de un prompt según su mtime."""
...
def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts usando caché LRU con invalidación mtime."""

...
def _load_prompt_cached(filepath: str, mtime: float) -> str:
    """Carga y cachea el contenido de un prompt dado su filepath y timestamp de modificación."""
    with open(filepath, "r", encoding="utf-8") as f:
        return f.read()


def clear_prompt_caches() -> None:
    """Limpia el cache LRU de templates de prompt."""
    _load_prompt_cached.cache_clear()


def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts utilizando caching mtime."""

...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    3. Reemplaza todas las {{variables}} de forma eficiente
    ...
    """
    # Cargar prompt maestro y del GEM (aprovecha cache)
    ...
    def replace_var(match):
        ...
        if key in variables:
            ...
            return str(val)
        return match.group(0)  # Mantener si no está en variables

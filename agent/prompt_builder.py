...
def build_prompt(gem_name: str, variables: dict) -> str:
    """
    Construye el prompt final para un GEM (Optimizado con re.sub).

    1. Carga el prompt del GEM y Maestro (desde cache)
    2. Realiza sustitución en una sola pasada usando regex

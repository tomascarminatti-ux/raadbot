...
# Pre-compile regex to avoid overhead in every build_prompt call
VARIABLE_REGEX = re.compile(r"\{\{(\w+)\}\}")


@lru_cache  # Cache to avoid repeated disk I/O for static templates
...
@lru_cache  # Cache the maestro prompt to avoid repeated disk I/O

...
def _load_prompt_cached(filepath: str, mtime: float) -> str:
    """Helper que lee y cachea la plantilla del prompt basándose en la mtime del archivo."""
    with open(filepath, "r", encoding="utf-8") as f:
        return f.read()


def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts usando cache con invalidación por mtime."""

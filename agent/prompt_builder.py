...
def _get_template_with_maestro(gem_name: str) -> str:
    """Carga el prompt y pre-inyecta el maestro."""
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    1. Carga el prompt del GEM con el maestro inyectado (desde cache)
    ...
    """
    # 1. Cargar template pre-inyectado
    prompt = _get_template_with_maestro(gem_name)

    # 2. Inyectar variables en una sola pasada usando regex
    ...
    # Solo buscamos si hay algo que no sea VERSION

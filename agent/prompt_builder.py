...
def load_prompt(gem_name: str) -> str:
    """Carga un prompt desde el directorio de prompts con cacheo."""
...
def load_maestro() -> str:
    """Carga el prompt maestro con cacheo."""
...
def build_prompt(gem_name: str, variables: dict) -> str:
    ...
    # Inyección de variables en una sola pasada usando regex
    def replace_var(match):
        ...
        if key in variables:
            ...
            return str(value)
        # Si no está en variables, mantener el placeholder {{key}}
        # EXCEPCIÓN: No reportar VERSION como faltante (comportamiento original)

...
class GEM6Orchestrator:
    ...
    async def run_pipeline(self, search_inputs: Dict[str, Any], candidates: Dict[str, Any]):
        ...
        # ⚡ Optimization: Process all candidates in parallel using asyncio.gather
        # This reduces total processing time from O(N) to roughly O(1) LLM batch latency
    ...
    async def process_context(self, context_data: Dict[str, Any]):
        ...
        while step < max_steps:
            ...
            # ⚡ Optimization: Offload synchronous run_gem to a thread to avoid blocking the event loop
    ...
    async def call_agent(self, agent_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gemini:
            try:
                ...
                # ⚡ Optimization: Offload synchronous run_gem to a thread

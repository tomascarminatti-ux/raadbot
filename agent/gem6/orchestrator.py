...
class GEM6Orchestrator:
    ...
    async def run_pipeline(self, search_inputs: Dict[str, Any], candidates: Dict[str, Any]):
        ...
        async def _process_candidate(candidate_id, candidate_data):
            context = {
        ...
        # Execute all candidates concurrently
        tasks = [_process_candidate(cid, cdata) for cid, cdata in candidates.items()]
    ...
    async def process_context(self, context_data: Dict[str, Any]):
        ...
        while step < max_steps:
            ...
            # 2. Call GEM 6 for reasoning (Offload sync call to thread)

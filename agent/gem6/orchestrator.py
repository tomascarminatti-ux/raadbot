...
class GEM6Orchestrator:
    ...
    async def run_pipeline(self, search_inputs: Dict[str, Any], candidates: Dict[str, Any]):
        ...
        # Save summary offloaded to thread to avoid blocking the event loop
        if self.output_dir:
    ...
    def _save_summary(self, results: Dict[str, Any]):
        """Synchronous helper to save pipeline summary"""
    ...
    async def process_context(self, context_data: Dict[str, Any]):
        ...
        while step < max_steps:
            ...
            # 2. Call GEM 6 for reasoning (offloaded to thread as it is synchronous)

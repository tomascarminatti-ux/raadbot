...
class GEM6Orchestrator:
    ...
    async def run_pipeline(self, search_inputs: Dict[str, Any], candidates: Dict[str, Any]):
        ...
        results = dict(zip(candidates.keys(), process_results))

        # Save summary (non-blocking I/O)
        if self.output_dir:
    ...
    async def process_context(self, context_data: Dict[str, Any]):
        ...
        while step < max_steps:
            ...
            # 2. Call GEM 6 for reasoning (non-blocking)
            ...
            if action == "call_agent":
                ...
                # validate_step calls validate_contract which does file I/O
    ...
    async def validate_step(self, entity_id, agent_id, output, contract_path, trace_id):
        # file check and validate_contract are blocking I/O

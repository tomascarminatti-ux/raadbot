...
def validate_config():
    """Validates critical configuration at runtime."""
...
PRICE_PROMPT_1M = 0.10   # Example price
PRICE_COMPLETION_1M = 0.40   # Example price
...
# Security: Regex for valid identifiers to prevent path traversal

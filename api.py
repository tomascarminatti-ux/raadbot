...
class PipelineRequest(BaseModel):
    ...
    def validate_webhook_url(cls, v: Optional[HttpUrl]) -> Optional[HttpUrl]:
        ...
        try:
            ...
            # If it was an IP but is_private raised, re-raise it
            if "Private or reserved IP addresses" in str(e):
                raise
...
async def run_pipeline(request: PipelineRequest) -> dict:
    ...
    # Defensive sanitization using os.path.basename() as a secondary layer

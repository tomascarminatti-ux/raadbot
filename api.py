...
class SetupSearchRequest(BaseModel):
    ...
    def validate_search_id(cls, v: str) -> str:
        if not ID_PATTERN.match(v):
            raise ValueError("search_id contains invalid characters. Only alphanumeric, underscores, and hyphens are allowed.")
        return v
...
class RefineRequest(BaseModel):
    ...
    def validate_gem_id(cls, v: str) -> str:
        if not ID_PATTERN.match(v):
            raise ValueError("gem_id contains invalid characters. Only alphanumeric, underscores, and hyphens are allowed.")
        return v

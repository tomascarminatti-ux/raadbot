...
class PipelineRequest(BaseModel):
    # Identifiers must be alphanumeric (plus _ and -) to prevent path traversal/injection
    ...
    def validate_local_dir(cls, v: Optional[str]) -> Optional[str]:
        if v:
            ...
            if ".." in v or v.startswith("/") or ":" in v:
                raise ValueError("Invalid local_dir: directory traversal or absolute paths not allowed")
        return v

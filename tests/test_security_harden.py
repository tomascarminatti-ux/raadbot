...
def test_identifier_validation():
    ...
    payloads = [
        {"entity_id": "../../etc/passwd", "current_stage": "GEM1",
            "state": "PROC", "agent_responsible": "GEM6", "trace_id": "T1"},
        {"entity_id": "valid_id", "current_stage": "GEM1", "state": "PROC",
            "agent_responsible": "invalid; drop table", "trace_id": "T1"},
    ]
...
def test_log_discovery_validation():
    ...
    payload = {"entity_id": "valid",
               "agent_id": "'; drop table discovery_logs; --", "trace_id": "T1"}

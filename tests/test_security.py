...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"❌ Search ID traversal test failed: {str(e) or 'Assertion Error'}")
        errors += 1
    ...
    try:
        ...
        print(f"❌ Local dir traversal test failed: {str(e) or 'Assertion Error'}")
        errors += 1
    ...
    try:
        ...
        print(f"❌ Refine gem traversal test failed: {str(e) or 'Assertion Error'}")
        errors += 1
    ...
    try:
        ...
        print(f"❌ Valid request failed validation: {str(e) or 'Assertion Error'}")
        errors += 1
